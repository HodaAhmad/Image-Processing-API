...
var dir = path_1.default.join(__dirname, '../../images/original/');
//thumbnail directory
var thumbDir = path_1.default.join(__dirname, '../../images/thumb/');
//main function to resize image
var transformImage = function (filename, height, width) { return __awaiter(void 0, void 0, void 0, function () {
    var outputFile, inputFile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                outputFile = thumbDir + filename + '_thumb_' + width + '_' + height + '.jpg';
                inputFile = dir + filename + '.jpg';
                // Check if input image exist in original image folder
                if (!(0, checkFile_1.default)(inputFile)) {
                    throw new Error('input image is not found');
                }
                if (!!(0, checkFile_1.default)(outputFile)) return [3 /*break*/, 4];
                if (!!fs_1.default.existsSync(thumbDir)) return [3 /*break*/, 2];
                return [4 /*yield*/, fs_1.default.promises.mkdir(thumbDir)];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: 
